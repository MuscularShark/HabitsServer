...
router.post('/add/:userId', (req, res) => {
    ...
    const shortInsulin = Math.round((req.body.weight * 0.2) * (req.body.sugar - 7.2) * 100) / 100 ;
    const longInsulin = Math.round(((req.body.weight * 0.2) * (req.body.sugar - 7.2) * 1.125) * 100) / 100;
...
router.get('/getList/:userId', (req, res) => {
    ...
    models.Sugar.find({userId: userId}, (err, sugars) => {
        if(err){
            console.log(err);
        }
        else{
...
//     models.Deal.find({userId: userId/*, dateOfCreation: {$gt : from, $lt: to}*/}, (err, deals) => {
//         if(err){
//             console.log(err);
//         }
//         else{
...
//             models.Deal.find({userId: userId}, (err, dealss) => {
//                 if(err){
//                     console.log(err);
//                 } else {
//                     deals.forEach(deal => {
...
//     models.Deal.find({userId: userId}, (err, deals) => {
//         if(err){
//             console.log(err);
//         } else {
//             deals.forEach(deal => {
